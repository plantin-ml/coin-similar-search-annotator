...
# )
# import logging
# from api.db.repositories.users import UsersRepository
# from api.schemas.auth import UserInCreate, UserInDB, UserLogin, UserToken
...
#     async def get_user(self, token: Annotated[str, Depends(oauth2_scheme)]) -> UserInDB | None:
#         """
